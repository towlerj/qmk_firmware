...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______, _______, _______, U_T_AGCR, _______, KC_PSCR, KC_SLCK, KC_PAUS, _______, LSFT(KC_VOLD) ,\
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   _______, _______, _______, _______, _______,  _______, _______, _______,          KC_APP,  KC_MSTP ,\
        _______, L_T_MD,  L_T_ONF, _______, _______, MD_BOOT, NK_TOGG, _______, _______,  _______, _______, _______,          KC_VOLU, KC_MPLY ,\
