...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT_65_ansi_blocker(
        ...
        KC_DEL,  		  		KC_Q,	KC_W,    KC_E,    KC_R,			KC_T,    TD(TD_CPL_TOG),	KC_U,    		 KC_I,    KC_O,    KC_P,    KC_LBRC,	KC_RBRC, KC_BSLS, KC_HOME,
    ...
    [FUNC] = LAYOUT_65_ansi_blocker(
        ...
        RESET, KC_LGUI, KC_LALT,                            _______,                            _______, _______, KC_HOME, KC_PGDN, KC_END
    ),
