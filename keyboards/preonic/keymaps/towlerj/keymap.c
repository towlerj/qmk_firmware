 ...
 * |   `  |      |      |      |      |      |      |      |      |      |      |CtAlDt|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |CtrlW | ShHm | ShNd |CtrlT |      |      |      |AlPrSc|PrntSn|      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_RAISE] = LAYOUT_preonic_grid(
    KC_GRV,  _______, _______, _______,    _______,   _______, _______, _______, _______, _______,    _______,    C(A(KC_DEL)),
    _______, _______, C(KC_W), S(KC_HOME), S(KC_END), C(KC_T), _______, _______, _______, A(KC_PSCR), KC_PSCR,    _______,
